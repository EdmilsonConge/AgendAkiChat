...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        a1 = new JPanel();
        a1.setLayout(new BoxLayout(a1, BoxLayout.Y_AXIS)); // melhor que BorderLayout fixo
        ...
        text.setBorder(new LineBorder(new Color(200, 200, 200), 1, true)); // borda arredondada
        jFrame.add(text);
        ...
        send.setBorder(new LineBorder(new Color(7, 94, 84), 1, true)); // botão arredondado
